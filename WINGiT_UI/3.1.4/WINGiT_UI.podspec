Pod::Spec.new do |s|
    ...
    s.source =                  { :http => "https://wingitprod.blob.core.windows.net/files/WINGiT_UI_3.1.4.zip"}

    s.framework =               "UIKit"
    s.cocoapods_version =       '>= 1.0'
    s.ios.vendored_framework =  'WINGiT_UI.framework'
    s.ios.dependency            'WINGiT', '~> 3.1.4'
end
