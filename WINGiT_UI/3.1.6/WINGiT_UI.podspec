Pod::Spec.new do |s|
    ...
    s.source =                  { :http => "https://wingitprod.blob.core.windows.net/files/WINGiT_UI_3.1.6.zip"}

    s.framework =               "UIKit"
    s.cocoapods_version =       '>= 1.0'
    s.ios.vendored_framework =  'WINGiT_UI_3.1.6/WINGiT_UI.framework'
    s.ios.dependency            'WINGiT_API', '~> 3.1.6'
end
